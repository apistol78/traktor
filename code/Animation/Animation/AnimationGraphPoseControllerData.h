...
public:
	...
	explicit AnimationGraphPoseControllerData(const resource::Id< RtStateGraphData >& stateGraph);
	...
	inline const resource::Id< RtStateGraphData >& getStateGraph() const { return m_stateGraph; }
