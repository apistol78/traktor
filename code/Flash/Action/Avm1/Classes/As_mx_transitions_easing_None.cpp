...
void As_mx_transitions_easing_None::createPrototype()
{
	...
	prototype->setMember(L"easeIn", createNativeFunctionValue(this, &As_mx_transitions_easing_None::None_easeIn));
	prototype->setMember(L"easeInOut", createNativeFunctionValue(this, &As_mx_transitions_easing_None::None_easeInOut));
	prototype->setMember(L"easeOut", createNativeFunctionValue(this, &As_mx_transitions_easing_None::None_easeOut));
...
ActionValue As_mx_transitions_easing_None::construct(ActionContext* context, const args_t& args)
{
	return ActionValue();
}
