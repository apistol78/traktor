...
bool RenderServer::create(Settings* settings)
{
...
void RenderServer::createResourceFactories(IEnvironment* environment)
{
...
int32_t RenderServer::reconfigure(const Settings* settings)
{
...
void RenderServer::update(Settings* settings)
{
#if !defined(_PS3)
...
render::IRenderSystem* RenderServer::getRenderSystem()
{
	return m_renderSystem;
}

render::IRenderView* RenderServer::getRenderView()
{
	return m_renderView;
}

Ref< render::RenderTargetSet > RenderServer::createOffscreenTarget(render::TextureFormat format, bool createDepthStencil, bool usingPrimaryDepthStencil)
{
