...
T_IMPLEMENT_RTTI_CLASS(L"traktor.jungle.BooleanTemplate", BooleanTemplate, IValueTemplate)

BooleanTemplate::BooleanTemplate(const std::wstring& tag, float threshold)
:	m_tag(tag)
