...
T_IMPLEMENT_RTTI_CLASS(L"traktor.jungle.FloatTemplate", FloatTemplate, IValueTemplate)

FloatTemplate::FloatTemplate(const std::wstring& tag, float threshold)
:	m_tag(tag)
...
FloatTemplate::FloatTemplate(const std::wstring& tag, float threshold, float min, float max, FloatTemplatePrecision precision, bool cyclic)
:	m_tag(tag)
,	m_threshold(threshold)
,	m_min(min)
,	m_max(max)
