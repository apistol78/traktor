...
T_IMPLEMENT_RTTI_CLASS(L"traktor.spark.ActionObjectRelay", ActionObjectRelay, Collectable)
...
bool ActionObjectRelay::enumerateMembers(AlignedVector< uint32_t >& outMemberNames) const
{
	return false;
}
