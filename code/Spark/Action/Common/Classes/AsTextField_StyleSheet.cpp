...
#include "Spark/Action/Common/Classes/AsTextField_StyleSheet.h"
...
T_IMPLEMENT_RTTI_CLASS(L"traktor.spark.AsTextField_StyleSheet", AsTextField_StyleSheet, ActionClass)
