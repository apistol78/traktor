...
T_IMPLEMENT_RTTI_CLASS(L"traktor.spark.PathControl", PathControl, ui::Widget)

bool PathControl::create(ui::Widget* parent, int style)
{
	if (!ui::Widget::create(parent, style))
		return false;

	addEventHandler< ui::PaintEvent >(this, &PathControl::eventPaint);
	addEventHandler< ui::MouseButtonDownEvent >(this, &PathControl::eventMouseButtonDown);
	addEventHandler< ui::MouseButtonUpEvent >(this, &PathControl::eventMouseButtonUp);
	addEventHandler< ui::MouseMoveEvent >(this, &PathControl::eventMouseMove);
	addEventHandler< ui::MouseWheelEvent >(this, &PathControl::eventMouseWheel);
	addEventHandler< ui::KeyDownEvent >(this, &PathControl::eventKeyDown);
...
void PathControl::setPath(const Path& path)
{
	m_path = path;
...
void PathControl::eventMouseButtonDown(ui::MouseButtonDownEvent* event)
{
	m_lastMousePosition = event->getPosition();
	setCapture();
}

void PathControl::eventMouseButtonUp(ui::MouseButtonUpEvent* event)
{
	releaseCapture();
}

void PathControl::eventMouseMove(ui::MouseMoveEvent* event)
{
	if (hasCapture())
	{
...
void PathControl::eventMouseWheel(ui::MouseWheelEvent* event)
{
...
void PathControl::eventKeyDown(ui::KeyDownEvent* event)
{
