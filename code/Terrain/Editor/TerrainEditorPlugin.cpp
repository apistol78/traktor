...
bool TerrainEditorPlugin::create(ui::Widget* parent, ui::ToolBar* toolBar)
{
	...
	toolBar->addItem(new ui::ToolBarSeparator());
	toolBar->addItem(new ui::ToolBarButton(L"Apply", ui::Command(L"Terrain.Editor.ApplySpline")));
	toolBar->addItem(new ui::ToolBarButton(L"Flatten", ui::Command(L"Terrain.Editor.FlattenUnderSpline")));
	toolBar->addItem(new ui::ToolBarSeparator());
