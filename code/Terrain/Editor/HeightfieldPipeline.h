#ifndef traktor_terrain_HeightfieldPipeline_H
#define traktor_terrain_HeightfieldPipeline_H
...
class T_DLLCLASS HeightfieldPipeline : public editor::Pipeline
{
...
#endif	// traktor_terrain_HeightfieldPipeline_H
