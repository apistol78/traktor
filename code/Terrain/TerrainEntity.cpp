...
void TerrainEntity::render(render::RenderContext* renderContext, const world::WorldRenderView* worldRenderView)
{
	...
	bool updateCache =
		bool(worldRenderView->getTechnique() != world::WorldRenderer::getTechniqueShadowMapOccluders()) &&
		bool(worldRenderView->getTechnique() != world::WorldRenderer::getTechniqueShadowMapSelfShadow()) &&
