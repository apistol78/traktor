#ifndef traktor_illuminate_IlluminateEditorProfile_H
#define traktor_illuminate_IlluminateEditorProfile_H
...
class T_DLLCLASS IlluminateEditorProfile : public scene::ISceneEditorProfile
{
	T_RTTI_CLASS;
...
#endif	// traktor_illuminate_IlluminateEditorProfile_H
