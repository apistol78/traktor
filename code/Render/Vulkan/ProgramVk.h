...
public:
	...
	VkShaderModule getRayGenVkShaderModule() const { return m_rayGenShaderModule; }

	VkShaderModule getRayHitVkShaderModule() const { return m_rayHitShaderModule; }

	VkShaderModule getRayMissVkShaderModule() const { return m_rayMissShaderModule; }
...
private:
	...
	VkShaderModule m_rayGenShaderModule = 0;
	VkShaderModule m_rayHitShaderModule = 0;
	VkShaderModule m_rayMissShaderModule = 0;
