...
bool initializeVulkanApi()
{
	...
	vkGetPhysicalDeviceFormatProperties = (PFN_vkGetPhysicalDeviceFormatProperties)GetProcAddress(s_hVulkanModule, "vkGetPhysicalDeviceFormatProperties");
	...
	vkCmdCopyImage = (PFN_vkCmdCopyImage)GetProcAddress(s_hVulkanModule, "vkCmdCopyImage");
	...
	vkGetImageSubresourceLayout = (PFN_vkGetImageSubresourceLayout)GetProcAddress(s_hVulkanModule, "vkGetImageSubresourceLayout");
	...
	vkDestroyImage = (PFN_vkDestroyImage)GetProcAddress(s_hVulkanModule, "vkDestroyImage");
	...
	vkInvalidateMappedMemoryRanges = (PFN_vkInvalidateMappedMemoryRanges)GetProcAddress(s_hVulkanModule, "vkInvalidateMappedMemoryRanges");
	...
	vkCmdCopyBuffer = (PFN_vkCmdCopyBuffer)GetProcAddress(s_hVulkanModule, "vkCmdCopyBuffer");
	...
	vkDestroyShaderModule = (PFN_vkDestroyShaderModule)GetProcAddress(s_hVulkanModule, "vkDestroyShaderModule");
	...
	vkDestroyDescriptorSetLayout = (PFN_vkDestroyDescriptorSetLayout)GetProcAddress(s_hVulkanModule, "vkDestroyDescriptorSetLayout");
	...
	vkDestroyPipelineLayout = (PFN_vkDestroyPipelineLayout)GetProcAddress(s_hVulkanModule, "vkDestroyPipelineLayout");
	...
	vkDestroySampler = (PFN_vkDestroySampler)GetProcAddress(s_hVulkanModule, "vkDestroySampler");
...
bool initializeVulkanExtensions(VkInstance instance)
{
	...
	*(void**)&vkCmdBeginDebugUtilsLabelEXT = vkGetInstanceProcAddr(instance, "vkCmdBeginDebugUtilsLabelEXT");
	...
	*(void**)&vkCmdEndDebugUtilsLabelEXT = vkGetInstanceProcAddr(instance, "vkCmdEndDebugUtilsLabelEXT");
