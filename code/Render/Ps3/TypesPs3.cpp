...
bool getGcmTextureInfo(TextureFormat textureFormat, int& outByteSize, uint8_t& outGcmFormat)
{
	...
	case TfR5G6B5:
		outByteSize = 2;
		outGcmFormat = CELL_GCM_TEXTURE_R5G6B5;
		break;
	...
	case TfX1R5G5B5:
		outByteSize = 2;
		outGcmFormat = CELL_GCM_TEXTURE_D1R5G5B5;
		break;

	case TfA1R5G5B5:
		outByteSize = 2;
		outGcmFormat = CELL_GCM_TEXTURE_A1R5G5B5;
		break;

	case TfX8R8G8B8:
		outByteSize = 4;
		outGcmFormat = CELL_GCM_TEXTURE_D8R8G8B8;
		break;
