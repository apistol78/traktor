...
#include "Render/Editor/Image/ImageProcessStepBlurFacade.h"
#include "Render/Editor/Image/ImageProcessStepBokehFacade.h"
#include "Render/Editor/Image/ImageProcessStepChainFacade.h"
#include "Render/Editor/Image/ImageProcessStepComputeFacade.h"
#include "Render/Editor/Image/ImageProcessStepGodRayFacade.h"
#include "Render/Editor/Image/ImageProcessStepGrainFacade.h"
#include "Render/Editor/Image/ImageProcessStepLuminanceFacade.h"
#include "Render/Editor/Image/ImageProcessStepRepeatFacade.h"
#include "Render/Editor/Image/ImageProcessStepSetTargetFacade.h"
#include "Render/Editor/Image/ImageProcessStepSimpleFacade.h"
#include "Render/Editor/Image/ImageProcessStepSmProjFacade.h"
#include "Render/Editor/Image/ImageProcessStepSsaoFacade.h"
#include "Render/Editor/Image/ImageProcessStepSwapTargetsFacade.h"
#include "Render/Editor/Image/ImageProcessStepTemporalFacade.h"
#include "Render/Editor/Image/ImageProcessProperties.h"
...
bool ImageProcessEditor::create(ui::Widget* parent, db::Instance* instance, ISerializable* object)
{
	...
	m_asset = dynamic_type_cast< ImageProcessData* >(object);
	if (!m_asset)
		return false;
...
bool ImageProcessEditor::handleCommand(const ui::Command& command)
{
	...
	{
		const TypeInfo* stepType = m_editor->browseType(makeTypeInfoSet< ImageProcessStep >(), false, true);
		if (stepType)
		{
