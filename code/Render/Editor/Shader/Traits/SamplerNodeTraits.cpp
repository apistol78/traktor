	...
	const PinType* inputPinTypes) const
{
	...
	return (samplerNode->getSamplerState().compare == CompareFunction::None) ? PinType::Scalar4 : PinType::Scalar1;
}
	...
	const PinType* outputPinTypes) const
{
	...
	else
	{
		...
		case PinType::Texture2D:
			return (samplerNode->getSamplerState().compare == CompareFunction::None) ? PinType::Scalar2 : PinType::Scalar3;

		case PinType::Texture3D:
		case PinType::TextureCube:
			return (samplerNode->getSamplerState().compare == CompareFunction::None) ? PinType::Scalar3 : PinType::Scalar4;
