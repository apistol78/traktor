#ifndef traktor_render_PolynomialNodeTraits_H
#define traktor_render_PolynomialNodeTraits_H
...
class PolynomialNodeTraits : public INodeTraits
{
	T_RTTI_CLASS;
...
#endif	// traktor_render_PolynomialNodeTraits_H
