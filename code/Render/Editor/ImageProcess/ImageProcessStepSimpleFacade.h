#ifndef traktor_render_ImageProcessStepSimpleFacade_H
#define traktor_render_ImageProcessStepSimpleFacade_H
...
class ImageProcessStepSimpleFacade : public IImageProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_render_ImageProcessStepSimpleFacade_H
