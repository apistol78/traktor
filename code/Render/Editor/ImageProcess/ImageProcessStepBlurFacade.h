#ifndef traktor_render_ImageProcessStepBlurFacade_H
#define traktor_render_ImageProcessStepBlurFacade_H
...
class ImageProcessStepBlurFacade : public IImageProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_render_ImageProcessStepBlurFacade_H
