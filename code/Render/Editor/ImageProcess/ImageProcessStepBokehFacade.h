#ifndef traktor_render_ImageProcessStepBokehFacade_H
#define traktor_render_ImageProcessStepBokehFacade_H
...
class ImageProcessStepBokehFacade : public IImageProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_render_ImageProcessStepBokehFacade_H
