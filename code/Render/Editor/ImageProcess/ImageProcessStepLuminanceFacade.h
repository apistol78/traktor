#ifndef traktor_render_ImageProcessStepLuminanceFacade_H
#define traktor_render_ImageProcessStepLuminanceFacade_H
...
class ImageProcessStepLuminanceFacade : public IImageProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_render_ImageProcessStepLuminanceFacade_H
