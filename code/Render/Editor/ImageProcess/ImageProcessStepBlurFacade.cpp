...
int32_t ImageProcessStepBlurFacade::getImage(const ImageProcessStep* step) const
{
	return 0;
}

std::wstring ImageProcessStepBlurFacade::getText(const ImageProcessStep* step) const
{
...
{
	const ImageProcessStepBlur* blur = checked_type_cast< const ImageProcessStepBlur*, false >(step);
