#ifndef traktor_world_PostProcessStepSsaoFacade_H
#define traktor_world_PostProcessStepSsaoFacade_H
...
class PostProcessStepSsaoFacade : public IPostProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_world_PostProcessStepSsaoFacade_H
