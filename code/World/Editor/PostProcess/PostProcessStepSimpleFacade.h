#ifndef traktor_world_PostProcessStepSimpleFacade_H
#define traktor_world_PostProcessStepSimpleFacade_H
...
class PostProcessStepSimpleFacade : public IPostProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_world_PostProcessStepSimpleFacade_H
