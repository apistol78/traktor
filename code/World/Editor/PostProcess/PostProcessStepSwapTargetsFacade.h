#ifndef traktor_world_PostProcessStepSwapTargetsFacade_H
#define traktor_world_PostProcessStepSwapTargetsFacade_H
...
class PostProcessStepSwapTargetsFacade : public IPostProcessStepFacade
{
	T_RTTI_CLASS;
