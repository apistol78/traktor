#ifndef traktor_world_PostProcessStepBokehFacade_H
#define traktor_world_PostProcessStepBokehFacade_H
...
class PostProcessStepBokehFacade : public IPostProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_world_PostProcessStepBokehFacade_H
