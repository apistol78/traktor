#ifndef traktor_world_PostProcessStepChainFacade_H
#define traktor_world_PostProcessStepChainFacade_H
...
class PostProcessStepChainFacade : public IPostProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_world_PostProcessStepChainFacade_H
