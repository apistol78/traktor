#ifndef traktor_world_PostProcessStepGodRayFacade_H
#define traktor_world_PostProcessStepGodRayFacade_H
...
class PostProcessStepGodRayFacade : public IPostProcessStepFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_world_PostProcessStepGodRayFacade_H
