...
/*! Billboard atlas texture pipeline.
 * \ingroup World
 *
 * Replicate the referenced entity as a model, then software rasterize that model
 * from every angle in the atlas grid into a single texture.
 */
class T_DLLCLASS BillboardTexturePipeline : public editor::DefaultPipeline
{
	T_RTTI_CLASS;
