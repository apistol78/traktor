 ...
 */
#include "World/Editor/Overlays/IrradianceFilteredOverlay.h"
...
T_IMPLEMENT_RTTI_FACTORY_CLASS(L"traktor.world.IrradianceFilteredOverlay", 0, IrradianceFilteredOverlay, BaseOverlay)

bool IrradianceFilteredOverlay::create(resource::IResourceManager* resourceManager)
{
