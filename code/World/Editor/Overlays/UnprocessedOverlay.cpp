...
T_IMPLEMENT_RTTI_FACTORY_CLASS(L"traktor.world.UnprocessedOverlay", 0, UnprocessedOverlay, BaseOverlay)
...
void UnprocessedOverlay::setup(render::RenderGraph& renderGraph, render::ScreenRenderer* screenRenderer, World* world, IWorldRenderer* worldRenderer, const WorldRenderView& worldRenderView, float alpha, float mip) const
{
	const render::RGTargetSet visualId = findTargetByName(renderGraph, L"Visual");
	if (visualId == render::RGTargetSet::Invalid)
	{
