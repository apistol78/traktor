...
T_IMPLEMENT_RTTI_FACTORY_CLASS(L"traktor.world.GBufferRoughnessOverlay", 0, GBufferRoughnessOverlay, BaseOverlay)
...
void GBufferRoughnessOverlay::setup(render::RenderGraph& renderGraph, render::ScreenRenderer* screenRenderer, World* world, IWorldRenderer* worldRenderer, const WorldRenderView& worldRenderView, float alpha, float mip) const
{
