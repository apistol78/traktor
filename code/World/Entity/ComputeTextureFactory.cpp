...
T_IMPLEMENT_RTTI_FACTORY_CLASS(L"traktor.world.ComputeTextureFactory", 0, ComputeTextureFactory, resource::IResourceFactory)

ComputeTextureFactory::ComputeTextureFactory(render::IRenderSystem* renderSystem)
...
{
	return makeTypeInfoSet< render::ITexture >();
}
