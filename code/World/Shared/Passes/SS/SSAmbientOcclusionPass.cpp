...
T_IMPLEMENT_RTTI_CLASS(L"traktor.world.SSAmbientOcclusionPass", SSAmbientOcclusionPass, Object)

bool SSAmbientOcclusionPass::create(resource::IResourceManager* resourceManager, render::IRenderSystem* renderSystem, const WorldCreateDesc& desc)
{
	T_FATAL_ASSERT(desc.quality.ambientOcclusion > Quality::Disabled);
...
void SSAmbientOcclusionPass::destroy()
{
	safeDestroy(m_screenRenderer);
}

render::RGTargetSet SSAmbientOcclusionPass::setup(
...
{
	T_PROFILER_SCOPE(L"SSAmbientOcclusionPass::setup");
