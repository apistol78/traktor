...
T_IMPLEMENT_RTTI_CLASS(L"traktor.world.RTAmbientOcclusionPass", RTAmbientOcclusionPass, Object)

bool RTAmbientOcclusionPass::create(resource::IResourceManager* resourceManager, render::IRenderSystem* renderSystem, const WorldCreateDesc& desc)
{
...
void RTAmbientOcclusionPass::destroy()
{
	safeDestroy(m_screenRenderer);
}

render::RGTargetSet RTAmbientOcclusionPass::setup(
...
{
	T_PROFILER_SCOPE(L"RTAmbientOcclusionPass::setup");
