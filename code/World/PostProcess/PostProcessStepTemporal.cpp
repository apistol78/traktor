...
T_IMPLEMENT_RTTI_FACTORY_CLASS(L"traktor.world.PostProcessStepTemporal", 0, PostProcessStepTemporal, PostProcessStep)

Ref< PostProcessStep::Instance > PostProcessStepTemporal::create(
...
void PostProcessStepTemporal::serialize(ISerializer& s)
{
	s >> resource::Member< render::Shader >(L"shader", m_shader);
	s >> MemberStlVector< Source, MemberComposite< Source > >(L"sources", m_sources);
}

PostProcessStepTemporal::Source::Source()
:	index(0)
{
}

void PostProcessStepTemporal::Source::serialize(ISerializer& s)
{
...
PostProcessStepTemporal::InstanceTemporal::InstanceTemporal(const PostProcessStepTemporal* step, const resource::Proxy< render::Shader >& shader, const std::vector< Source >& sources)
:	m_step(step)
,	m_shader(shader)
,	m_sources(sources)
,	m_time(0.0f)
...
void PostProcessStepTemporal::InstanceTemporal::destroy()
{
}

void PostProcessStepTemporal::InstanceTemporal::render(
