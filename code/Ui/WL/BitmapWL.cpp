...
void BitmapWL::copySubImage(const drawing::Image* image, const Rect& srcRect, const Point& destPos)
{
	if (!image)
		return;
...
Ref< drawing::Image > BitmapWL::getImage() const
{
	const Size size = getSize();
