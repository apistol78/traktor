#ifndef traktor_sound_BlendGrainFacade_H
#define traktor_sound_BlendGrainFacade_H
...
class BlendGrainFacade : public IGrainFacade
{
	T_RTTI_CLASS;
...
#endif	// traktor_sound_BlendGrainFacade_H
