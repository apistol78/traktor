...
struct MethodTrunk_0 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_0(method_t method)
	:	m_method(method)
	{
	}
	...
	{
		ReturnType returnValue = (*m_method)(T_VERIFY_CAST_SELF(ClassType, self));
...
struct MethodTrunk_0< ClassType, void > final : public IRuntimeDispatch
{
	...
	virtual Any invoke(ITypedObject* self, uint32_t argc, const Any* argv) const override final
	{
		(*m_method)(T_VERIFY_CAST_SELF(ClassType, self));
		return Any();
	}
};
...
struct MethodTrunk_1 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_1(method_t method)
	:	m_method(method)
	{
	}
...
struct MethodTrunk_2 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_2(method_t method)
	:	m_method(method)
	{
	}
...
struct MethodTrunk_3 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_3(method_t method)
	:	m_method(method)
	{
	}
...
struct MethodTrunk_4 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_4(method_t method)
	:	m_method(method)
	{
	}
...
struct MethodTrunk_5 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_5(method_t method)
	:	m_method(method)
	{
	}
...
struct MethodTrunk_6 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_6(method_t method)
	:	m_method(method)
	{
	}
...
struct MethodTrunk_7 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_7(method_t method)
	:	m_method(method)
	{
	}
...
struct MethodTrunk_8 final : public IRuntimeDispatch
{
	...
	explicit MethodTrunk_8(method_t method)
	:	m_method(method)
	{
	}
