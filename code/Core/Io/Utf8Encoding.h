#ifndef traktor_Utf8Encoding_H
#define traktor_Utf8Encoding_H
 ...
 * \ingroup Core
 */
class T_DLLCLASS Utf8Encoding : public Encoding
{
	T_RTTI_CLASS(Utf8Encoding)
