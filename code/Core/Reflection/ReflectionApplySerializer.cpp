...
bool ReflectionApplySerializer::operator >> (const Member< bool >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< int8_t >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< uint8_t >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< int16_t >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< uint16_t >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< int32_t >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< uint32_t >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< int64_t >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< uint64_t >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< float >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< double >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< std::string >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< std::wstring >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< Guid >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< Path >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< Scalar >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< Vector2 >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< Vector4 >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< Matrix33 >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< Matrix44 >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< Quaternion >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< ISerializable* >& m)
{
...
bool ReflectionApplySerializer::operator >> (const Member< void* >& m)
{
	T_FATAL_ERROR;
	return false;
}

bool ReflectionApplySerializer::operator >> (const MemberArray& m)
{
...
bool ReflectionApplySerializer::operator >> (const MemberComplex& m)
{
...
bool ReflectionApplySerializer::operator >> (const MemberEnumBase& m)
{
	Ref< const RfmEnum > member = dynamic_type_cast< const RfmEnum* >(getNextMember());
	if (member)
		return m.set(member->get());
	else
		return false;
}
