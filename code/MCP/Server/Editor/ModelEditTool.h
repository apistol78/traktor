...
/*! Tool: apply a batch of fine-grained mutations to an open model.
 * \ingroup MCP
 */
class ModelEditTool : public IMcpTool
{
	T_RTTI_CLASS;

public:
	explicit ModelEditTool(editor::IEditor* editor, ModelSession* session);
