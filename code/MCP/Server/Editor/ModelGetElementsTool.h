...
/*! Tool: page through a model's raw element arrays.
 * \ingroup MCP
 */
class ModelGetElementsTool : public IMcpTool
{
	T_RTTI_CLASS;

public:
	explicit ModelGetElementsTool(editor::IEditor* editor, ModelSession* session);
