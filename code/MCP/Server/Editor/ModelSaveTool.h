...
/*! Tool: persist an open model to a file and/or a MeshAsset.
 * \ingroup MCP
 */
class ModelSaveTool : public IMcpTool
{
	T_RTTI_CLASS;

public:
	explicit ModelSaveTool(editor::IEditor* editor, ModelSession* session);
