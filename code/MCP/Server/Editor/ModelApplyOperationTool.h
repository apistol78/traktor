...
/*! Tool: apply global model operations to an open model.
 * \ingroup MCP
 */
class ModelApplyOperationTool : public IMcpTool
{
	T_RTTI_CLASS;

public:
	explicit ModelApplyOperationTool(editor::IEditor* editor, ModelSession* session);
