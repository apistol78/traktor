...
/*! Tool: summarize an open model (counts, bounds, materials, skeleton, animations).
 * \ingroup MCP
 */
class ModelInspectTool : public IMcpTool
{
	T_RTTI_CLASS;

public:
	explicit ModelInspectTool(editor::IEditor* editor, ModelSession* session);
