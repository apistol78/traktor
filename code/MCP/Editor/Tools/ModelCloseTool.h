...
/*! Tool: release a working model (or all of them) from the model session.
 * \ingroup MCP
 */
class ModelCloseTool : public IMcpTool
{
	T_RTTI_CLASS;

public:
	explicit ModelCloseTool(editor::IEditor* editor, ModelSession* session);
