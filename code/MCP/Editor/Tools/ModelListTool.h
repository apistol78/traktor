...
/*! Tool: list the models currently open in the model session.
 * \ingroup MCP
 */
class ModelListTool : public IMcpTool
{
	T_RTTI_CLASS;

public:
	explicit ModelListTool(editor::IEditor* editor, ModelSession* session);
