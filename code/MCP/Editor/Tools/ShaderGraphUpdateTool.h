...
/*! Tool: replace an existing shader graph's content from the IR.
 * \ingroup MCP
 */
class ShaderGraphUpdateTool : public IMcpTool
{
	T_RTTI_CLASS;

public:
	explicit ShaderGraphUpdateTool(editor::IEditor* editor);
