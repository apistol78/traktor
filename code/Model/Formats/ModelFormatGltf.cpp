...
#include "Model/Formats/ModelFormatGltf.h"
...
Ref< Model > ModelFormatGltf::read(const Path& filePath, uint32_t importFlags, const std::function< Ref< IStream >(const Path&) >& openStream) const
{
