...
//		for (int i = 0; i < 100; ++i)
//			objects.push_back(new HeapObject(i));
//
//		Atomic::increment(g_allocCount);
//
//		ThreadManager::getInstance().getCurrentThread()->sleep(0);
...
{
	//{
	//	Ref< LengthyCtorObject > foo = new LengthyCtorObject();
	//	CASE_ASSERT(foo);
	//}

	//{
	//	Ref< HeapObject > foo1 = new HeapObject(0);

	//	{
	//		Ref< HeapObject > foo2 = new HeapObject(1);
	//		Ref< HeapObject > foo3 = new HeapObject(2);
