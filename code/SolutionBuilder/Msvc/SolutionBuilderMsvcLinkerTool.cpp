...
bool SolutionBuilderMsvcLinkerTool::generate(GeneratorContext& context, Solution* solution, Project* project, Configuration* configuration, OutputStream& os) const
{
...
void SolutionBuilderMsvcLinkerTool::serialize(ISerializer& s)
{
	if (s.getVersion() >= 1)
	{
