...
T_IMPLEMENT_RTTI_FACTORY_CLASS(L"traktor.weather.PrecipitationRenderer", 0, PrecipitationRenderer, world::IEntityRenderer)

bool PrecipitationRenderer::initialize(const ObjectStore& objectStore)
{
	return true;
}
