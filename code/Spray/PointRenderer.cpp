...
,	m_pointOffset(0)
{
	...
	m_vertexBuffer = renderSystem->createBuffer(render::BuVertex, 4 * sizeof(EmitterVertex), false, T_FILE_LINE_W);
	...
	m_indexBuffer = renderSystem->createBuffer(render::BuIndex, 6 * sizeof(uint16_t), false, T_FILE_LINE_W);
	...
	*index++ = 3;
	...
	m_pointBuffer = renderSystem->createBuffer(render::BuStructured, c_pointCount * sizeof(Point), true, T_FILE_LINE_W);
