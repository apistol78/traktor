...
/*! Pipeline of theater entity components.
 * \ingroup Theater
 *
 * Exist in order to strip the acts of everything only the editor need.
 */
class T_DLLCLASS TheaterEntityComponentPipeline : public editor::IPipeline
{
	T_RTTI_CLASS;
