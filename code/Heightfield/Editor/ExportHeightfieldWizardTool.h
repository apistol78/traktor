#ifndef traktor_hf_ExportHeightfieldWizardTool_H
#define traktor_hf_ExportHeightfieldWizardTool_H
...
class T_DLLCLASS ExportHeightfieldWizardTool : public editor::IWizardTool
{
	T_RTTI_CLASS;
...
#endif	// traktor_hf_ExportHeightfieldWizardTool_H
