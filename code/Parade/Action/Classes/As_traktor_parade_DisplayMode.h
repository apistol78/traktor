#ifndef traktor_parade_As_traktor_parade_DisplayMode_h
#define traktor_parade_As_traktor_parade_DisplayMode_h
...
class As_traktor_parade_DisplayMode : public flash::ActionClass
{
	T_RTTI_CLASS;

public:
	As_traktor_parade_DisplayMode(flash::ActionContext* context, amalgam::IEnvironment* environment);
...
#endif	// traktor_parade_As_traktor_parade_DisplayMode_h
