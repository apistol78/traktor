...
T_IMPLEMENT_RTTI_CLASS(L"traktor.parade.As_traktor_parade_DisplayMode", As_traktor_parade_DisplayMode, flash::ActionClass)

As_traktor_parade_DisplayMode::As_traktor_parade_DisplayMode(flash::ActionContext* context, amalgam::IEnvironment* environment)
:	flash::ActionClass(context, "traktor.parade.DisplayMode")
,	m_environment(environment)
{
	addProperty("availableModes", createNativeFunction(context, this, &As_traktor_parade_DisplayMode::DisplayMode_get_availableModes), 0);

	Ref< flash::ActionObject > prototype = new flash::ActionObject(context);

	prototype->addProperty("width", createNativeFunction(context, this, &As_traktor_parade_DisplayMode::DisplayMode_get_width), 0);
	prototype->addProperty("height", createNativeFunction(context, this, &As_traktor_parade_DisplayMode::DisplayMode_get_height), 0);
	prototype->addProperty("refreshRate", createNativeFunction(context, this, &As_traktor_parade_DisplayMode::DisplayMode_get_refreshRate), 0);
	prototype->addProperty("colorBits", createNativeFunction(context, this, &As_traktor_parade_DisplayMode::DisplayMode_get_colorBits), 0);
	prototype->addProperty("stereoscopic", createNativeFunction(context, this, &As_traktor_parade_DisplayMode::DisplayMode_get_stereoscopic), 0);
...
void As_traktor_parade_DisplayMode::initialize(flash::ActionObject* self)
{
}
