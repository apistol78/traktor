#ifndef traktor_parade_IValueTemplate_H
#define traktor_parade_IValueTemplate_H
...
public:
	...
	virtual Ref< const IValue > extrapolate(const IValue* Vn1, float Tn1, const IValue* V0, float T0, float T) const = 0;
...
#endif	// traktor_parade_IValueTemplate_H
