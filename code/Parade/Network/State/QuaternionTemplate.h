#ifndef traktor_parade_QuaternionTemplate_H
#define traktor_parade_QuaternionTemplate_H
...
class T_DLLCLASS QuaternionTemplate : public IValueTemplate
{
	T_RTTI_CLASS;
...
#endif	// traktor_parade_QuaternionTemplate_H
