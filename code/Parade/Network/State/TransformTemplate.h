#ifndef traktor_parade_TransformTemplate_H
#define traktor_parade_TransformTemplate_H
...
class T_DLLCLASS TransformTemplate : public IValueTemplate
{
	T_RTTI_CLASS;
...
#endif	// traktor_parade_TransformTemplate_H
