...
static const YYCODETYPE yy_lookahead[] = {
 ...
 /*   800 */    78,   79,   80,   55,   55,   55,   55,   55,   55,   55,
 /*   810 */    55,   55,   55,   55,   55,   55,   55,   55,   55,   55,
 /*   820 */    55,   55,   55,   55,   55,   55,   55,   55,   55,   55,
 /*   830 */    55,   55,   55,   55,   55,   55,   55,   55,   55,   55,
 /*   840 */    55,   55,   55,   55,   55,   55,   55,   55,   55,   55,
 /*   850 */    55,   55,   55,   55,   55,   55,   55,   55,
};
...
static const YYCODETYPE yyFallback[] = {
    ...
    0,  /*         OR => nothing */
    0,  /*        AND => nothing */
    0,  /* LESS_EQUAL => nothing */
    0,  /* GREATER_EQUAL => nothing */
    ...
    0,  /*     NUMBER => nothing */
    0,  /*     STRING => nothing */
    0,  /* DOT_DOT_DOT => nothing */
    0,  /* BITWISE_OR => nothing */
    0,  /* BITWISE_AND => nothing */
    0,  /* LEFT_BRACKET => nothing */
    0,  /* RIGHT_BRACKET => nothing */
    0,  /* RIGHT_PARANTHESIS => nothing */
    0,  /* LEFT_BRACE => nothing */
    0,  /* RIGHT_BRACE => nothing */
};
#endif /* YYFALLBACK */
...
static const YYCODETYPE yyRuleInfoLhs[] = {
    55,  /* (0) chunk ::= block */
    56,  /* (1) block ::= scope statlist */
    56,  /* (2) block ::= scope statlist laststat semi */
    61,  /* (3) ublock ::= block UNTIL exp */
    58,  /* (4) scope ::= */
    58,  /* (5) scope ::= scope statlist binding semi */
    59,  /* (6) statlist ::= */
    59,  /* (7) statlist ::= statlist stat semi */
    64,  /* (8) stat ::= DO block END */
    64,  /* (9) stat ::= WHILE exp DO block END */
    64,  /* (10) stat ::= repetition DO block END */
    64,  /* (11) stat ::= REPEAT ublock */
    64,  /* (12) stat ::= IF conds END */
    64,  /* (13) stat ::= FUNCTION funcname funcbody */
    64,  /* (14) stat ::= setlist EQUAL explist1 */
    64,  /* (15) stat ::= functioncall */
    66,  /* (16) conds ::= condlist */
    66,  /* (17) conds ::= condlist ELSE block */
    74,  /* (18) condlist ::= cond */
    74,  /* (19) condlist ::= condlist ELSEIF cond */
    75,  /* (20) cond ::= exp THEN block */
    60,  /* (21) laststat ::= BREAK */
    60,  /* (22) laststat ::= RETURN */
    60,  /* (23) laststat ::= RETURN explist1 */
    63,  /* (24) binding ::= LOCAL namelist */
    63,  /* (25) binding ::= LOCAL namelist EQUAL explist1 */
    63,  /* (26) binding ::= LOCAL namelist LESS CONST GREATER EQUAL explist1 */
    63,  /* (27) binding ::= LOCAL FUNCTION NAME funcbody */
    67,  /* (28) funcname ::= dottedname */
    67,  /* (29) funcname ::= dottedname COLON NAME */
    76,  /* (30) dottedname ::= NAME */
    76,  /* (31) dottedname ::= dottedname DOT NAME */
    73,  /* (32) namelist ::= NAME */
    73,  /* (33) namelist ::= namelist COMMA NAME */
    70,  /* (34) explist1 ::= exp */
    70,  /* (35) explist1 ::= explist1 COMMA exp */
    72,  /* (36) explist23 ::= exp COMMA exp */
    72,  /* (37) explist23 ::= exp COMMA exp COMMA exp */
    62,  /* (38) exp ::= NIL|TRUE|FALSE|NUMBER|STRING|DOT_DOT_DOT */
    62,  /* (39) exp ::= function */
    62,  /* (40) exp ::= prefixexp */
    62,  /* (41) exp ::= tableconstructor */
    62,  /* (42) exp ::= NOT|HASH|MINUS exp */
    62,  /* (43) exp ::= exp OR exp */
    62,  /* (44) exp ::= exp AND exp */
    62,  /* (45) exp ::= exp LESS|LESS_EQUAL|GREATER|GREATER_EQUAL|EQUAL_EQUAL|NOT_EQUAL exp */
    62,  /* (46) exp ::= exp DOT_DOT exp */
    62,  /* (47) exp ::= exp BITWISE_OR exp */
    62,  /* (48) exp ::= exp BITWISE_AND exp */
    62,  /* (49) exp ::= exp PLUS|MINUS exp */
    62,  /* (50) exp ::= exp MULTIPLY|DIVIDE|MODULO exp */
    62,  /* (51) exp ::= exp RAISE exp */
    80,  /* (52) var ::= NAME */
    80,  /* (53) var ::= prefixexp LEFT_BRACKET exp RIGHT_BRACKET */
    80,  /* (54) var ::= prefixexp DOT NAME */
    78,  /* (55) prefixexp ::= var */
    78,  /* (56) prefixexp ::= functioncall */
    78,  /* (57) prefixexp ::= OPEN exp RIGHT_PARANTHESIS */
    71,  /* (58) functioncall ::= prefixexp args */
    71,  /* (59) functioncall ::= prefixexp COLON NAME args */
    81,  /* (60) args ::= LEFT_PARANTHESIS RIGHT_PARANTHESIS */
    81,  /* (61) args ::= LEFT_PARANTHESIS explist1 RIGHT_PARANTHESIS */
    81,  /* (62) args ::= tableconstructor */
    81,  /* (63) args ::= STRING */
    77,  /* (64) function ::= FUNCTION funcbody */
    68,  /* (65) funcbody ::= params block END */
    57,  /* (66) semi ::= SEMICOLON */
    57,  /* (67) semi ::= */
    65,  /* (68) repetition ::= FOR NAME EQUAL explist23 */
    65,  /* (69) repetition ::= FOR namelist IN explist1 */
    69,  /* (70) setlist ::= var */
    69,  /* (71) setlist ::= setlist COMMA var */
    82,  /* (72) params ::= LEFT_PARANTHESIS parlist RIGHT_PARANTHESIS */
    83,  /* (73) parlist ::= */
    83,  /* (74) parlist ::= namelist */
    83,  /* (75) parlist ::= DOT_DOT_DOT */
    83,  /* (76) parlist ::= namelist COMMA DOT_DOT_DOT */
    79,  /* (77) tableconstructor ::= LEFT_BRACE RIGHT_BRACE */
    79,  /* (78) tableconstructor ::= LEFT_BRACE fieldlist RIGHT_BRACE */
    79,  /* (79) tableconstructor ::= LEFT_BRACE fieldlist COMMA|SEMICOLON RIGHT_BRACE */
    84,  /* (80) fieldlist ::= field */
    84,  /* (81) fieldlist ::= fieldlist COMMA|SEMICOLON field */
    85,  /* (82) field ::= exp */
    85,  /* (83) field ::= NAME EQUAL exp */
    85,  /* (84) field ::= LEFT_BRACKET exp RIGHT_BRACKET EQUAL exp */
};
...
static const signed char yyRuleInfoNRhs[] = {
   -1,  /* (0) chunk ::= block */
   -2,  /* (1) block ::= scope statlist */
   -4,  /* (2) block ::= scope statlist laststat semi */
   -3,  /* (3) ublock ::= block UNTIL exp */
    0,  /* (4) scope ::= */
   -4,  /* (5) scope ::= scope statlist binding semi */
    0,  /* (6) statlist ::= */
   -3,  /* (7) statlist ::= statlist stat semi */
   -3,  /* (8) stat ::= DO block END */
   -5,  /* (9) stat ::= WHILE exp DO block END */
   -4,  /* (10) stat ::= repetition DO block END */
   -2,  /* (11) stat ::= REPEAT ublock */
   -3,  /* (12) stat ::= IF conds END */
   -3,  /* (13) stat ::= FUNCTION funcname funcbody */
   -3,  /* (14) stat ::= setlist EQUAL explist1 */
   -1,  /* (15) stat ::= functioncall */
   -1,  /* (16) conds ::= condlist */
   -3,  /* (17) conds ::= condlist ELSE block */
   -1,  /* (18) condlist ::= cond */
   -3,  /* (19) condlist ::= condlist ELSEIF cond */
   -3,  /* (20) cond ::= exp THEN block */
   -1,  /* (21) laststat ::= BREAK */
   -1,  /* (22) laststat ::= RETURN */
   -2,  /* (23) laststat ::= RETURN explist1 */
   -2,  /* (24) binding ::= LOCAL namelist */
   -4,  /* (25) binding ::= LOCAL namelist EQUAL explist1 */
   -7,  /* (26) binding ::= LOCAL namelist LESS CONST GREATER EQUAL explist1 */
   -4,  /* (27) binding ::= LOCAL FUNCTION NAME funcbody */
   -1,  /* (28) funcname ::= dottedname */
   -3,  /* (29) funcname ::= dottedname COLON NAME */
   -1,  /* (30) dottedname ::= NAME */
   -3,  /* (31) dottedname ::= dottedname DOT NAME */
   -1,  /* (32) namelist ::= NAME */
   -3,  /* (33) namelist ::= namelist COMMA NAME */
   -1,  /* (34) explist1 ::= exp */
   -3,  /* (35) explist1 ::= explist1 COMMA exp */
   -3,  /* (36) explist23 ::= exp COMMA exp */
   -5,  /* (37) explist23 ::= exp COMMA exp COMMA exp */
   -1,  /* (38) exp ::= NIL|TRUE|FALSE|NUMBER|STRING|DOT_DOT_DOT */
   -1,  /* (39) exp ::= function */
   -1,  /* (40) exp ::= prefixexp */
   -1,  /* (41) exp ::= tableconstructor */
   -2,  /* (42) exp ::= NOT|HASH|MINUS exp */
   -3,  /* (43) exp ::= exp OR exp */
   -3,  /* (44) exp ::= exp AND exp */
   -3,  /* (45) exp ::= exp LESS|LESS_EQUAL|GREATER|GREATER_EQUAL|EQUAL_EQUAL|NOT_EQUAL exp */
   -3,  /* (46) exp ::= exp DOT_DOT exp */
   -3,  /* (47) exp ::= exp BITWISE_OR exp */
   -3,  /* (48) exp ::= exp BITWISE_AND exp */
   -3,  /* (49) exp ::= exp PLUS|MINUS exp */
   -3,  /* (50) exp ::= exp MULTIPLY|DIVIDE|MODULO exp */
   -3,  /* (51) exp ::= exp RAISE exp */
   -1,  /* (52) var ::= NAME */
   -4,  /* (53) var ::= prefixexp LEFT_BRACKET exp RIGHT_BRACKET */
   -3,  /* (54) var ::= prefixexp DOT NAME */
   -1,  /* (55) prefixexp ::= var */
   -1,  /* (56) prefixexp ::= functioncall */
   -3,  /* (57) prefixexp ::= OPEN exp RIGHT_PARANTHESIS */
   -2,  /* (58) functioncall ::= prefixexp args */
   -4,  /* (59) functioncall ::= prefixexp COLON NAME args */
   -2,  /* (60) args ::= LEFT_PARANTHESIS RIGHT_PARANTHESIS */
   -3,  /* (61) args ::= LEFT_PARANTHESIS explist1 RIGHT_PARANTHESIS */
   -1,  /* (62) args ::= tableconstructor */
   -1,  /* (63) args ::= STRING */
   -2,  /* (64) function ::= FUNCTION funcbody */
   -3,  /* (65) funcbody ::= params block END */
   -1,  /* (66) semi ::= SEMICOLON */
    0,  /* (67) semi ::= */
   -4,  /* (68) repetition ::= FOR NAME EQUAL explist23 */
   -4,  /* (69) repetition ::= FOR namelist IN explist1 */
   -1,  /* (70) setlist ::= var */
   -3,  /* (71) setlist ::= setlist COMMA var */
   -3,  /* (72) params ::= LEFT_PARANTHESIS parlist RIGHT_PARANTHESIS */
    0,  /* (73) parlist ::= */
   -1,  /* (74) parlist ::= namelist */
   -1,  /* (75) parlist ::= DOT_DOT_DOT */
   -3,  /* (76) parlist ::= namelist COMMA DOT_DOT_DOT */
   -2,  /* (77) tableconstructor ::= LEFT_BRACE RIGHT_BRACE */
   -3,  /* (78) tableconstructor ::= LEFT_BRACE fieldlist RIGHT_BRACE */
   -4,  /* (79) tableconstructor ::= LEFT_BRACE fieldlist COMMA|SEMICOLON RIGHT_BRACE */
   -1,  /* (80) fieldlist ::= field */
   -3,  /* (81) fieldlist ::= fieldlist COMMA|SEMICOLON field */
   -1,  /* (82) field ::= exp */
   -3,  /* (83) field ::= NAME EQUAL exp */
   -5,  /* (84) field ::= LEFT_BRACKET exp RIGHT_BRACKET EQUAL exp */
};
