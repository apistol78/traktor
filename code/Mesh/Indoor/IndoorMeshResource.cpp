...
T_IMPLEMENT_RTTI_SERIALIZABLE_CLASS(L"traktor.mesh.IndoorMeshResource", IndoorMeshResource, MeshResource)
...
bool IndoorMeshResource::serialize(Serializer& s)
{
...
bool IndoorMeshResource::Part::serialize(Serializer& s)
{
...
bool IndoorMeshResource::Sector::serialize(Serializer& s)
{
...
bool IndoorMeshResource::Portal::serialize(Serializer& s)
{
