#ifndef traktor_mesh_MeshEditorProfile_H
#define traktor_mesh_MeshEditorProfile_H
...
class T_DLLCLASS MeshEditorProfile : public scene::ISceneEditorProfile
{
	T_RTTI_CLASS;
...
#endif	// traktor_mesh_MeshEditorProfile_H
