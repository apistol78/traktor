...
T_IMPLEMENT_RTTI_EDIT_CLASS(L"traktor.physics.AiCharacterComponentData", 0, AiCharacterComponentData, world::IEntityComponentData)

Ref< AiCharacterComponent > AiCharacterComponentData::createComponent(
...
) const
{
	...
	return new AiCharacterComponent(
		physicsManager,
		this,
		bodyWide,
		bodySlim,
...
Ref< ShapeDesc > AiCharacterComponentData::getShapeDesc(float epsilon) const
{
...
int32_t AiCharacterComponentData::getOrdinal() const
{
	return -200;
}

void AiCharacterComponentData::setTransform(const world::EntityData* owner, const Transform& transform)
{
}

void AiCharacterComponentData::serialize(ISerializer& s)
{
