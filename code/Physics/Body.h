...
public:
	...
	/*! Move kinematic body to a world transform over a time step.
	 *
	 * \param transform World transform to reach.
	 * \param deltaTime Time step in which to reach it.
	 */
	virtual void moveKinematic(const Transform& transform, float deltaTime) = 0;
