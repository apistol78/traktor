 ...
 * \ingroup Jolt
 */
class T_DLLCLASS Hinge2JointJolt : public JointJolt< Hinge2Joint, JPH::SixDOFConstraint >
{
	T_RTTI_CLASS;

public:
	explicit Hinge2JointJolt(IWorldCallback* callback, JPH::SixDOFConstraint* constraint, BodyJolt* body1, BodyJolt* body2);
