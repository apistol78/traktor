#ifndef traktor_input_InThresholdTraits_H
#define traktor_input_InThresholdTraits_H
...
class InThresholdTraits : public InputNodeTraits
{
public:
...
#endif	// traktor_input_InThresholdTraits_H
