#ifndef traktor_input_InReadValueTraits_H
#define traktor_input_InReadValueTraits_H
...
class InReadValueTraits : public InputNodeTraits
{
public:
...
#endif	// traktor_input_InReadValueTraits_H
