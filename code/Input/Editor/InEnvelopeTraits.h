#ifndef traktor_input_InEnvelopeTraits_H
#define traktor_input_InEnvelopeTraits_H
...
class InEnvelopeTraits : public InputNodeTraits
{
public:
...
#endif	// traktor_input_InEnvelopeTraits_H
