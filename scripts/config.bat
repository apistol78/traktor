...
set EMBREE_SDK=%TRAKTOR_HOME%\3rdp\embree-windows\embree-4.4.1.x64.windows
...
set LUA_SDK=%TRAKTOR_HOME%\3rdp\lua\lua-5.5.0
...
set RENDERDOC_SDK=%TRAKTOR_HOME%\3rdp\renderdoc\RenderDoc_1.45_64
...
if not defined VULKAN_SDK (
    ...
    set HAVE_SYSTEM_VULKAN_SDK=false
) else (
