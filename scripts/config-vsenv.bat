...
if /i not "%VERSION%" == "vs2017_x64" ( goto :skip_vs2017_x64 )
echo Set VS2017 (x64) environment
...
if /i not "%VERSION%" == "vs2017_x86" ( goto :skip_vs2017_x86 )
echo Set VS2017 (x86) environment
