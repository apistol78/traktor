...
LD=/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/clang++
SDK_SYSROOT=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk
...
# Create dSYM file which contain debug symbols.
dsymutil \
	--arch=armv7 \
	--out=$ARG_EXECUTABLE.dSYM \
	$ARG_EXECUTABLE
