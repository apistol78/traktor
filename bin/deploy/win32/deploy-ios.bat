...
if "%1"=="build" (
	...
	:: Sign bundle.
	%TRAKTOR_HOME%\bin\win32\RemoteLaunch -w %DEPLOY_TARGET_HOST% sign-ios.sh "%BUNDLE%" "%DEPLOY_CERTIFICATE%" >> "%LOGFILE%"
	...
	:: Deploy optional mobile provision file into bundle.
	pushd %DEPLOY_PROJECT_ROOT:/=\%\res\deploy\ios
